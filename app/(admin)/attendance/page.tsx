...
export default function AdminAttendancePage() {
  ...
  // Reset pagination and exit edit mode on filter changes
  useEffect(() => {
    setCurrentPage(1);
    setIsEditing(false);
    setEditedStatuses({});
              ...
              <div className="flex items-center gap-3">
                {records.length > 0 && !isEditing && (
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 rounded-xl bg-amber-500/10 border border-amber-500/20 text-amber-400 text-sm font-medium hover:bg-amber-500/20 transition-colors"
                  >
                ...
                {isEditing && (
                  <>
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/[0.05] border border-white/10 text-gray-300 text-sm font-medium hover:bg-white/[0.1] transition-colors"
                    >
                      <X className="w-4 h-4" />
                      Cancel
                    </button>
                    <button
                      ...
                      disabled={isSaving}
                      className="flex items-center gap-2 px-4 py-2 rounded-xl bg-green-500/10 border border-green-500/20 text-green-400 text-sm font-medium hover:bg-green-500/20 transition-colors disabled:opacity-60"
                    >
                      ...
                      <div className="flex items-center sm:justify-center ml-12 sm:ml-0">
                        {isEditing ? (
                          <button
                            ...
                            className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-lg text-xs font-semibold transition-all cursor-pointer hover:scale-105 ${
                              (editedStatuses[record.id] || record.status) === 'present'
