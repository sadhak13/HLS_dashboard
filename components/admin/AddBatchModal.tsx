...
// Shared input class for the glass-dark style
...
export function AddBatchModal({ isOpen, onClose, onSuccess, branch }: AddBatchModalProps) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={`Add Batch${branch ? ` to ${branch.name}` : ''}`}>
